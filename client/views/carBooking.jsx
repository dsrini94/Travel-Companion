              ...
              <Grid.Row>
                ...
                <Form.Field>
                  ...
                  <SwipeableViews slideStyle={styles.slideContainer}>
                      ...
                      <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"Sixt Rent a Car")}>
                        <Image src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStaRUo9py1J-1SPv7FBf5sKAWD2zbNNI4Mpk1nNqSkccp5bXCm' />
                        <Card.Content>
                          <Card.Header>
                            Sixt Rent a Car
                          </Card.Header>
                      ...
                      <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"Avis")}>
                        <Image src='https://res.cloudinary.com/simpleview/image/upload/crm/reddirt/avis-images-a4d82bac5056b3a_a4d82fc5-5056-b3a8-49aa9076c347ecef.jpg' />
                        <Card.Content>
                          <Card.Header>
                            Avis
                          </Card.Header>
                      ...
                      <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"Europcar")}>
                        <Image src='https://cdn-static.boursier.com/illustrations/logos/l_europcarlogo.jpg' />
                        <Card.Content>
                          <Card.Header>
                            Europcar
                          </Card.Header>
