        ...
        <div className="imgHeight vhsidebar" style={{backgroundImage:"url("+this.props.notifications.backgroundImage+")"}}>
          ...
          <Grid>
             ...
             <Grid.Row>
               ...
               <Grid.Column width={7}>
                <span className="subheaders" style={{color:"white",fontSize:"14px",fontWeight:"bold"}}>{this.props.match.params.hotel}</span>
                <br/>
             ...
             <Grid.Row>
               ...
               <Grid.Column width={7}>
                <span className="subheaders" style={{color:"white",fontSize:"15px",fontWeight:"bold"}}>{this.props.match.params.cab}</span>
                <br/>
