...
const obj=[{
  from:'LHR',
  to:'CDG',
  fromAbbrevation:'London Heathrow Airport',
  toAbbrevation:'Paris Charles de Gaulle Airport',
  time:'18:35',
  arrives:'19:55',
  flightNo:'XX103',
  pnr:'D94ENF',
            ...
            <SwipeableViews index={this.state.slideIndex} disabled>
              ...
              <Grid.Row>
                ...
                <Grid.Column width={7}>
                 ...
                 <br/>
                 <span className="subheaders" style={{color:"white",fontSize:"11px",fontWeight:"bold"}}>Pick up: 13:30, Jun 28</span>
                 <br/>
                 <span className="subheaders" style={{color:"white",fontSize:"11px",fontWeight:"bold"}}>Drop: 13:30, Jun 30</span>
                </Grid.Column>
                <Grid.Column width={7}>
