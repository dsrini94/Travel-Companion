            ...
            <div className='imgHeight vhsidebar' style={{backgroundImage:"url("+this.props.notifications.backgroundImage+")"}}>
              ...
              <Grid.Row>
                ...
                <SwipeableViews slideStyle={styles1.slideContainer}>
                    <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"Hotel Hilton","$95")}>
                    ...
                    <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"InterContinental Hotel","$115")}>
                    ...
                    <Card style={{width:'85%',boxShadow:'none',border:'none'}} onClick={this.handleCardClick.bind(this,"Starwood Hotel","$120")}>
