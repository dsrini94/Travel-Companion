              ...
              <Grid>
                ...
                <Grid.Row>
                  ...
                  <Grid.Column width={14}>
                    <OnwardflightSearchResultCards from='LHR' to ='CDG' fromDetail='London Heathrow Airport' toDetail='Paris Charles de Gaulle Airport' value='1' seatNo="15F" time1={"Mon Jul 09 2018 17:50"} time2={"12:55 PM "+new Date(parseInt(this.props.match.params.onwardDate2)).toDateString()} time1v={this.props.match.params.onwardDate1} time2v={this.props.match.params.onwardDate2} flightNo='XX301'/>
                    <OnwardflightSearchResultCards from='LHR' to ='CDG' fromDetail='London Heathrow Airport' toDetail='Paris Charles de Gaulle Airport' value='2' seatNo="1D" time1={"Mon Jul 09 2018 20:35"} time2={"12:55 PM "+new Date(parseInt(this.props.match.params.onwardDate2)).toDateString()} time1v={this.props.match.params.onwardDate1} time2v={this.props.match.params.onwardDate2} flightNo='XX302'/>
                    <OnwardflightSearchResultCards from='LHR' to ='CDG' fromDetail='London Heathrow Airport' toDetail='Paris Charles de Gaulle Airport' value='3' seatNo="3I" time1={"Mon Jul 09 2018 18:35"} time2={"12:55 PM "+new Date(parseInt(this.props.match.params.onwardDate2)).toDateString()} time1v={this.props.match.params.onwardDate1} time2v={this.props.match.params.onwardDate2} flightNo='XX303'/>
                    <OnwardflightSearchResultCards from='LHR' to ='CDG' fromDetail='London Heathrow Airport' toDetail='Paris Charles de Gaulle Airport' value='4' seatNo="6A" time1={"Mon Jul 09 2018 21:00"} time2={"12:55 PM "+new Date(parseInt(this.props.match.params.onwardDate2)).toDateString()} time1v={this.props.match.params.onwardDate1} time2v={this.props.match.params.onwardDate2} flightNo='XX304'/>
                    <OnwardflightSearchResultCards from='LHR' to ='CDG' fromDetail='London Heathrow Airport' toDetail='Paris Charles de Gaulle Airport' value='5' seatNo="2C" time1={"Mon Jul 09 2018 22:40"} time2={"12:55 PM "+new Date(parseInt(this.props.match.params.onwardDate2)).toDateString()} time1v={this.props.match.params.onwardDate1} time2v={this.props.match.params.onwardDate2} flightNo='XX305'/>
                  </Grid.Column>
                  <Grid.Column width={1}></Grid.Column>
                </Grid.Row>
              </Grid>
