              ...
              <Card fluid style={{
                ...
                <Card.Content>
                  ...
                  <Grid.Row style={{marginBottom:"-20px"}}>
                    <Grid.Column>
                    <Header as="h6" style={{color:"white"}}>{item.date}</Header>
                    </Grid.Column>
                  </Grid.Row>
                    <Grid.Row >
                      <Grid.Column>
            ...
            {this.props.notifications.suggestedData.map((item,i)=>{
              ...
              <Card fluid style={{
                ...
                <Card.Content>
                  ...
                  <Grid.Row style={{marginBottom:"-20px"}}>
                    <Grid.Column>
                    <Header as="h6" style={{color:"white",margin:"0px"}}>{item.date}</Header>
                    <Header as="h6" style={{marginTop:"-10px"}} inverted floated="right">{item.travelType}</Header>
                    </Grid.Column>
                  </Grid.Row>
                    <Grid.Row >
                      <Grid.Column>
                      <Header as="h6" style={{color:"white",margin:"0px"}}>Duration {item.tt}</Header>
                      </Grid.Column>
