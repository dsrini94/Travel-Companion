...
class SelectedFlightComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    var temp1,
      temp = (<div><span className="subheaders">Hilton Hotel</span><br/></div>);
  ...
  cardClick(p) {
    ...
    this.setState({temp: temp,hotel:0,selectedHotel:p});

  }

  handleCabSelect(p) {
    var temp = (<span className="subheaders">{p}</span>)
    this.setState({cab: temp,cabAmount:0,selectedCab:p});
  }
  ...
  render() {
    ...
    if (this.props.match.params.from == 'LHR') {
      ...
      flightNo="XX103";
      fromName = "London Heathrow Airport";
      toName = "Paris Charles de Gaulle";
    } else if (this.props.match.params.from == 'CDG' && this.props.match.params.to == 'LHR') {
      datevalue = '2018-05-05';
      fromName = "Paris Charles de Gaulle Airport";
      toName = "London Heathrow Airport";
      flightNo = "XX008";
    } else if (this.props.match.params.from == 'LTN') {
      datevalue = '2018-07-30';
      fromName = "London Luton Airport";
      toName = "Amsterdam Airport Schiphol";
      flightNo = "XX011";
    } else if (this.props.match.params.from == 'AMS') {
      datevalue = '2018-08-13';
      fromName = "Amsterdam Airport Schiphol";
      toName = "London Luton Airport";
      flightNo = "XX010";
    } else if (this.props.match.params.from == 'ATL') {
            ...
            <div style={{
              ...
              <Grid style={{marginTop:"0px"}}>
                ...
                <Grid.Row style={{
                  ...
                  <br/>
                  <center><Button as={Link} to={`/summaryDetails/${'OneWay'}/${this.props.match.params.from}/${this.props.match.params.to}/${this.state.selectedHotel}/${this.state.selectedCab}`} inverted><Icon name="credit card alternative"/>{buttonName}</Button></center>
                  <br/>
                  <br/>
