  ...
  render() {
    ...
    return (<div>
      ...
      <Grid.Row>
        ...
        <Grid.Column width={7}>
         <span className="subheaders" style={{color:"white",fontSize:"14px",fontWeight:"bold"}}>Hotel Hilton</span>
         <br/>
         <span className="subheaders" style={{color:"white",fontSize:"11px",fontWeight:"bold"}}>CheckIn: 12:00, Jun 28</span>
         <br/>
         <span className="subheaders" style={{color:"white",fontSize:"11px",fontWeight:"bold"}}>Checkout: 12:00, Jun 30</span>
        </Grid.Column>
        <Grid.Column width={7}>
