          ...
          <br/>
            ...
            <Grid>
              <Grid.Row>
                <Grid.Column width={6}>
                  <center>
                    <span className='subheaders'>LHR</span><br/>
                    <span className='subheaders' style={{
                        margin: "5px",fontSize:"10px"
                      }}>London Heathrow Airport</span>
                  </center>
                </Grid.Column>
                <Grid.Column width={4}>
                  <center>
                ...
                <Grid.Column width={6}>
                  <center>
                    <span className='subheaders'>CDG</span><br/>
                    <span className='subheaders' style={{margin: "5px",fontSize:"10px"}}>Paris Charles de Gaulle Airport</span>
                  </center>
                </Grid.Column>
              </Grid.Row>
              ...
              <Grid.Row>
                ...
                <br/>
                <br/>
                <span className="subheaders" >18:55, Thur Jun 28, 2018</span>
                </Grid.Column>
                <Grid.Column width={1}>
                </Grid.Column>
              </Grid.Row>
              ...
              <Grid.Row>
                ...
                <Grid.Column width={10}>
                <span className="subheaders">19:55, Thur Jun 28, 2018</span>
                </Grid.Column>
                <Grid.Column width={1}>
                </Grid.Column>
              </Grid.Row>
